...
chimera::perforation::getPerforationFirstOperator()
{
  ...
  Op->addMutator(
      ::chimera::m_operator::MutatorPtr(new ::chimera::perforation::MutatorLoopPerforation1()));
