...
/// \brief This file contains operators implementation for VPA, native version
//===----------------------------------------------------------------------===//
...
chimera::vpa_nmutator::getVPANOperator() {
  ...
  Op->addMutator(
      ::chimera::m_operator::MutatorPtr(new ::chimera::vpa_nmutator::VPANFloatOperationMutator()));
